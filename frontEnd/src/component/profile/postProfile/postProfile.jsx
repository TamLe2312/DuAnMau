    ...
    return (
        <>
            <div className="container ProfilePostHeader">
                <div className="ProfileInformPost">
                    <div className="ProfilePostAvatarContent">
                        <a href="#" className="ProfilePostAvatarAndNameLink">
                            <img className="post-avatar" src="https://hinhnen4k.com/wp-content/uploads/2023/02/anh-gai-xinh-2k9-1.jpg" />
                        </a>&nbsp;
                ...
                <div><span className="ProfilePostFeatureButton"><MoreHorizIcon /></span></div>
            </div>
